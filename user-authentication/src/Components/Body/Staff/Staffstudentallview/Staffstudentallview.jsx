...
import './Staffstudentallview.css'
import { Link, useNavigate, useParams } from 'react-router-dom'
import axios from 'axios'

const Staffstudentallview = () => {
  ...
  return (
        <div className='student-full-view-color'>
                  <div className="admin-staff-back-btn">
                     <Link to={"/staffstudentview"}><button class="button-91" role="button">BACK</button></Link>
                   </div>
...
export default Staffstudentallview
