...
const Staffstudentview = () => {
  ...
  return (
    <div className='admin-staff-view-color'>
                        ...
                        <Link to={"/staffhome"}><button class="button-91" role="button">BACK</button></Link>
                        </div>
                    ...
                    <div className="row admin-staff-view-card">
                       {
                        ...
                        <div key={index} className="col-lg-3 admin-staff-view-card-1">
                            ...
                            <div className="admin-staff-view-delete-btn">
                                     <Link className='admin-staff-view-btn-link' to={`/Staffstudentallview/${data._id}`}><button className='admin-staff-view-btn'>View</button></Link>
